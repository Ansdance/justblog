...
@section('contentD')
	...
	<form action="{{ route('contactD-update-submit', $data->id) }}" method="post">
		@csrf
		...
		<div class="form-group">
			...
			<input type="text" name="email" value="{{ $data->email }}" placeholder="Введите имя" id="email" class="form-control">
		</div>
		...
		<button type="submit" class="btn btn-success btn-lg btn3d">Обновить</button>
